...
public final class MotionActivityMonitor: BaseMonitor {
    ...
    public var isAvailable: Bool {
        type(of: motionActivityManager).isActivityAvailable()
    }
    ...
    @Inject private var motionActivityManager: any MotionActivityManagerProtocol
