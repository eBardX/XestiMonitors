...
/// spatial axes.
public final class MagnetometerMonitor: BaseMonitor {
    ...
    public var info: Info {
        guard let data = motionManager.magnetometerData
        else { return .unknown }
    ...
    @Inject private var motionManager: any MotionManagerProtocol
