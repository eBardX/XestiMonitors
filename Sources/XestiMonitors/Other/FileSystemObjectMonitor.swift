...
public final class FileSystemObjectMonitor: BaseMonitor {
    ...
    @Inject private var fileSystem: any FileSystemProtocol
    @Inject private var makeFileSystemObject: MakeFileSystemObject
    ...
    override public func configureMonitor() {
        ...
        let fileSystemObject = makeFileSystemObject(fileDescriptor,
                                                    _makeEventMask(),
                                                    targetQueue)
