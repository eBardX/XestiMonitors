...
internal class MockMotionManager: MotionManagerProtocol {
    ...
    func updateAccelerometer(error: any Error) {
    ...
    func updateDeviceMotion(error: any Error) {
        deviceMotion = nil
    ...
    func updateGyroscope(error: any Error) {
        gyroData = nil
    ...
    func updateMagnetometer(error: any Error) {
