...
open class BaseNotificationMonitor: BaseMonitor {
    ...
    ///             `false` on failure.
    ///
    open func addNotificationObservers(_ notificationCenter: NotificationCenter) -> Bool {
    ...
    ///             or `false` on failure.
    ///
    open func removeNotificationObservers(_ notificationCenter: NotificationCenter) -> Bool {
